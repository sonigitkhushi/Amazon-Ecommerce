...
class PageSeeder extends ThemeSeeder
{
    ...
    public function run(): void
    {
        ...
        $this->createPages([
            ...
            [
                'name' => 'Brands',
                'content' => '[ecommerce-brands show_brand_name="1" enable_lazy_loading="yes"][/ecommerce-brands]',
            ],
            [
                'name' => 'Coupons',
