            ...
            <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                <div class="tp-product-details-quantity">
                    <div class="tp-product-quantity mb-15 mr-15">
                        ...
                        <input class="tp-cart-input" type="number" name="qty" min="1" value="{{ $product->minimum_order_quantity ?: 1 }}" max="{{ $product->maximum_order_quantity ?: ($product->with_storehouse_management ? $product->quantity : 1000) }}" @readonly($isOutOfStock) />
