                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-lg-6 col-md-6">
                                    <div class="tp-slider-content p-relative z-index-1">
                                        ...
                                        @endif
                                        @if ($title)
                                            <h3 class="tp-slider-title" @style(["font-size: {$shortcode->title_font_size}px" => $shortcode->title_font_size])>The best note book collection 2025</h3>
                                        @endif
                                        @if($description)
                                ...
                                <div class="col-xl-7 col-lg-6 col-md-6">
                                    ...
                                    <img src="https://www.transparentpng.com/download/tablet/android-tablets-png-clipart-wUmLWH.png" alt="">
                                    </div>
                                </div>
                            </div>
                        @else
